...
router.get('/testingMovies', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, filterMovies_1.returnMovies()];
            case 1:
                formattedMovies = _a.sent();
                // Guardar las películas en la base de datos
                return [4 /*yield*/, movieDbService_1.writeToDatabase(formattedMovies, 'kieran@123.ie')];
            case 2:
                // Guardar las películas en la base de datos
                _a.sent();
            ...
            case 3:
                err_1 = _a.sent();
                logger_1.logger.error("Error in /api/movies/testingMovies: " + err_1.message);
...
router.get('/returnMovies', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, movieDbService_1.getMoviesFromDatabase('kieran@123.ie')];
            case 1:
            ...
            case 2:
                err_2 = _a.sent();
                logger_1.logger.error("Error in /api/movies/returnMovies: " + err_2.message);
